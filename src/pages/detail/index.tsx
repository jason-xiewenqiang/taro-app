    ...
    return (
      <View className="detail-page">
        <View className="btn-group">
          <AtButton size="small" onClick={this.handleAssign.bind(this)}>指派</AtButton>
          <AtButton size="small" onClick={this.handleUpgrade.bind(this)}>升级</AtButton>
        </View>
        <View className="desc">
        ...
        <AtButton type='primary' circle onClick={this.commit.bind(this)}>提交</AtButton>
      </View>
    );
  }
}
